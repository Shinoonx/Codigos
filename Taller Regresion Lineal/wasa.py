...
# 2. Análisis Exploratorio y Correlación (Para Pregunta 1)
plt.figure(figsize=(8, 6))
correlation_matrix = df.corr()
sns.heatmap(correlation_matrix, annot=True, cmap='coolwarm', fmt=".2f")
plt.title("Matriz de Correlación de Variables")
plt.savefig("matriz_correlacion.png") # Guarda la imagen para tu informe
plt.show()

# 3. Separación de variables dependientes e independientes
X = df[['horsepower', 'age', 'mileage', 'engine_size']] # Variables independientes
...
# Características: Horsepower=165, Age=4, Mileage=58000, Engine_Size=2.0
